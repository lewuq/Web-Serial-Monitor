...
function PlotWorkspaceWidget({points,plots,detectedFields,plotWindow,panOffset,verticalPan,zh,onWindowSize,onPanOffset,onVerticalPan,onRemove}:{points:DataPoint[];plots:PlotConfig[];detectedFields:string[];plotWindow:number;panOffset:number;verticalPan:number;zh:boolean;onWindowSize:(value:number)=>void;onPanOffset:(value:number|((current:number)=>number))=>void;onVerticalPan:(value:number)=>void;onRemove:()=>void}) {
