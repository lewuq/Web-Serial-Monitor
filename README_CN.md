...
**在线使用：** [https://lewuq.github.io/Web-Serial-Monitor/](https://lewuq.github.io/Web-Serial-Monitor/)

## 版本迭代

| 版本 | 更新日期 | 主要内容 |
| --- | --- | --- |
| V0.5.1 | 2026-09-18 | 页面刷新或从浏览器缓存恢复后清空绘图；重置按钮会清空待处理及已显示的采样点，并恢复默认实时绘图视图。 |
| V0.5.0 | 2026-09-14 | 增加 GitHub Pages 生产部署工作流，并适配仓库子路径下的静态资源地址。 |
| V0.4.0 | 2026-09-12 | 新增最多三个绘图/控制组件的动态可调工作区，使终端自适应剩余屏幕，统一并优化视觉系统；停止 Demo 时同步停止全部输出，并完善 PID 参数发送。 |
| V0.3.1 | 2026-09-11 | 优化笔记本屏幕高度下的自适应布局，保持连接控制区可见，并通过视口自适应尺寸修复绘图、History 和 Terminal 的重叠问题。 |
| V0.3.0 | 2026-09-11 | 优化整体视觉质感，扩展遥测工作台布局，支持可缩放与可调整尺寸的绘图，新增 3D 欧拉角 IMU、含 PID 控制器的组件库，以及更完善的终端数据控制。 |
| V0.2.0 | 2026-09-11 | 遥测工作台、中英文界面、明暗主题、确定性文本解析、动态曲线、持续终端渲染和可拖放组件画布。 |
| V0.1.0 | 2026-09-09 | 首次提供基于浏览器的串口连接、终端和实时数值绘图功能。 |
...
本项目依据 [Web Serial Monitor 非商业许可证](LICENSE)开放源代码，可用于个人、教育、研究及其他非商业用途。商业使用、销售、付费分发、商业托管，或集成到商业产品与服务中，必须事先获得版权所有者的书面许可。
